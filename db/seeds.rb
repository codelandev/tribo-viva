...
if Rails.env.development? || Rails.env.staging?
  ...
  10.times do |index|
    Producer.create!(name: "Produtor #{index}",
                    ...
                    video_url: "https://www.youtube.com/watch?v=K7ToNJHgp-w",
  ...
  3.times do |index|
    ...
    10.times do |item|
      ...
      unit: OfferItemUnit.to_a.sample[1],
      offer: Offer.last,
      quantity: item,
      unit_price: 5+item
      )
    ...
    5.times do |index2|
      ...
      Purchase.create!(user: user, status: PurchaseStatus::PAID, total: 0, invoice_id: SecureRandom.hex)
