class Offer < ActiveRecord::Base
  ...
  validates :deliver_coordinator, :bank_account, :producer, :title, :image, :stock,
            :description, :offer_ends_at, :collect_ends_at, :offer_starts_at,
            :collect_starts_at, presence: true
